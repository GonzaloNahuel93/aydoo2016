...
public class FactoresPrimosTest {
	...
	public void factorizarElNumero20(){
		...
		FactoresPrimos numero20 = new FactoresPrimos();
		List<Integer> factores = numero20.obtenerFactoresPrimos(20);
	...
	public void factorizarElNumero90(){
		...
		FactoresPrimos numero90 = new FactoresPrimos();
		List<Integer> factores = numero90.obtenerFactoresPrimos(90);
	...
	public void factorizarElNumero360(){
		...
		FactoresPrimos numero360 = new FactoresPrimos();
		List<Integer> factores = numero360.obtenerFactoresPrimos(360);
	...
	public void factorizarElNumero1000(){
		...
		FactoresPrimos numero1000 = new FactoresPrimos();
		List<Integer> factores = numero1000.obtenerFactoresPrimos(1000);
	...
	public void factorizarElNumero2000(){
		...
		FactoresPrimos numero2000 = new FactoresPrimos();
		List<Integer> factores = numero2000.obtenerFactoresPrimos(2000);
